# Привет, я Тихонов Иван 👋

## 🚀 Обо мне

Я специалист в области **Data Science** и **Python-разработки** с сильной математической подготовкой. Быстро осваиваю новые технологии, имею опыт управления IT-проектами и стартапом в сфере ИИ. Активно участвую в хакатонах и кейс-чемпионатах, применяю знания к реальным бизнес-задачам.
...
- **Computer Science Center** – курсы по математическому анализу, линейной алгебре
- **Bioinformatics Institute** – основы математической статистики
- **VK (ВКонтакте)** – управление IT-проектами
- **AmoStart** – сертифицированный партнер-интегратор
- **Сертификаты** - https://github.com/Ivanmnmn/certificates (за кейс-чемпионаты и хакатоны и за прохождение курсов)
...
- 🏋️‍♂️ Пауэрлифтинг (участвовал в соревнованиях)
- 🎸 Учусь играть на гитаре
- 📖 Читаю книги по менеджменту и бизнесу
